...
module.exports = {
  async up(queryInterface) {
    ...
    const examples = [
      ...
      // ======================================================
      // UTILITIES INTENT - Time, date, current info
      // ======================================================
      ...
      { intent: 'utilities', text: 'Apa hari ini libur?', language: 'id' },
      { intent: 'utilities', text: 'Informasi waktu', language: 'id' },
      { intent: 'utilities', text: 'Waktu lokal', language: 'id' },
      { intent: 'utilities', text: 'Zona waktu', language: 'id' },
